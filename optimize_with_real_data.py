...
def save_optimization_results(conn, results, date_str):
    ...
    try:
        ...
        cur.execute(summary_query, (
            ...
            results['savings']['percentage_saved'],
            results['environmental']['water_used_gallons'],
            results['summary']['peak_demand_mw'],
            results['environmental']['water_saved_gallons'],
            results['environmental']['carbon_avoided_tons'],
            'optimal'
        ))
